...
import { create } from '@maxpatiiuk/custom-elements-manifest-analyzer/src/create.js';
  ...
  'custom-kinds': {
    ...
    exportKinds: {
      'custom-element-definition': {
        url: 'https://raw.githubusercontent.com/webcomponents/webcomponents.org/master/client/assets/logo.svg',
      },
      js: 'JavaScript',
    },
  },
